                  ...
                  {profileLoading ? (
                    ...
                    <div className={styles.sectionHeader}>
                      <div className={styles.sectionTitle}>
                        {t('overview.contributions.title', { count: totalContributions })}
                      </div>
                    </div>
                  )}
                  {profileLoading ? (
              ...
              <form onSubmit={handleCreateListSubmit}>
                ...
                <div className={styles.formGroup} style={{ marginBottom: '15px' }}>
                  ...
                  <input
                    ...
                    className={styles.inputField} // Đảm bảo class này có trong CSS module
                ...
                <div className={styles.formGroup} style={{ marginBottom: '15px' }}>
                  <label className={styles.inputLabel} style={{ display: 'block', marginBottom: '5px' }}>
                    {t('create_list_modal.fields.description.label') || "Description"}
                  </label>
                  <textarea
                    name="description"
                    value={newListData.description}
                    onChange={handleNewListInputChange}
                    className={styles.textareaField} // Đảm bảo class này có trong CSS module
                ...
                <div className={styles.formCheckboxGroup} style={{ marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  />
                  <label htmlFor="is_private" className={styles.checkboxLabel} style={{ cursor: 'pointer' }}>
                    {t('create_list_modal.fields.is_private.label') || "Private List"}
                  </label>
                </div>
